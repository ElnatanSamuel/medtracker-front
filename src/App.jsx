...
function App() {
  ...
  return (
    <div className="min-h-screen pb-32 max-w-lg mx-auto bg-slate-50">
      {/* Header */}
      <header className="sticky top-0 z-20 bg-white/70 backdrop-blur-md px-6 py-4 flex items-center justify-between border-b border-slate-100">
        <div>
      ...
      <nav className="fixed bottom-6 inset-x-6 h-20 bg-slate-900 rounded-[2.5rem] shadow-2xl flex items-center justify-around px-2 z-30 max-w-md mx-auto">
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1.5 px-4 py-2 transition-all duration-300 ${currentTab === "health" ? "text-white" : "text-slate-500 hover:text-slate-300"}`}
        >
          <Activity
            size={18}
            className={currentTab === "health" ? "scale-110" : ""}
          />
          <span className="text-[8px] font-black uppercase tracking-widest">
            Vitals
          </span>
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1.5 px-4 py-2 transition-all duration-300 ${currentTab === "analytics" ? "text-emerald-400" : "text-slate-500 hover:text-slate-300"}`}
        >
          <TrendingUp
            size={18}
            className={currentTab === "analytics" ? "scale-110" : ""}
          />
          <span className="text-[8px] font-black uppercase tracking-widest">
            Stats
          </span>
